...
def build_stage_diagnostics_payload(runner: Any, stage: Any, label: str) -> Dict[str, Any]:
    ...
    def gpu_target_detail(target: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "gpu_identity_source": target.get("gpu_identity_source", ""),
            "gpu_device_role": target.get("gpu_device_role", ""),
            "physical_gpu_id": target.get("physical_gpu_id", ""),
            "drm_driver": target.get("drm_driver", ""),
            "drm_device_role": target.get("drm_device_role", ""),
            "platform_gpu_driver": target.get("platform_gpu_driver", ""),
            "platform_gpu_compatible": target.get("platform_gpu_compatible", []),
            "platform_gpu_path": target.get("platform_gpu_path", ""),
            "platform_gpu_of_fullname": target.get("platform_gpu_of_fullname", ""),
            ...
            "selected_vulkan_device": dict(capability.get("selected_vulkan_device") or {}),
            "hardware_device_verified": bool(capability.get("hardware_device_verified")),
